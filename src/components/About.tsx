export const About: React.FC = () => {
  ...
  return (
    <section id="escritorio" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#FAF8F5] border-t border-b border-slate-300 relative">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <h2 className="text-2xl sm:text-4xl font-cinzel font-semibold text-[#3F5060] leading-snug">
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 border border-slate-300 rounded-2xl relative shadow-md overflow-hidden">
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              <h3 className="text-xl sm:text-2xl font-cinzel font-semibold text-[#3F5060]">
                Lucas Manoel Alves Garcia
              </h3>
              <p className="text-xs uppercase tracking-widest text-[#C8B195] font-semibold">
                LM Advocacia e Consultoria Jurídica
              </p>
            </div>

            <p className="text-base text-[#4A5866] leading-relaxed font-light">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-[#64748B] font-medium border-t border-slate-200">
              <span className="px-3.5 py-1.5 bg-[#FAF8F5] rounded-full border border-slate-300 text-[#3F5060] font-semibold">Inscrição OAB/SP</span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#C8B195]"></span>
              <span className="px-3.5 py-1.5 bg-[#FAF8F5] rounded-full border border-slate-300 text-[#3F5060] font-semibold">Atendimento Nacional & Internacional</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar, index) => (
            <div 
              key={pillar.title}
              className="p-6 bg-white border border-slate-300 hover:border-[#3F5060] rounded-xl transition-all flex flex-col justify-between shadow-xs group"
            >
              <div className="space-y-3">
                <span className="text-xs font-mono text-[#C8B195] font-bold">
                  0{index + 1}
                </span>
                <h4 className="text-lg font-cinzel font-semibold text-[#3F5060] tracking-wide">
                  {pillar.title}
                </h4>
              ...
              <div className="w-8 h-[2px] bg-slate-200 rounded-full mt-6 group-hover:bg-[#C8B195] transition-colors"></div>
            </div>
          ))}
        </div>
